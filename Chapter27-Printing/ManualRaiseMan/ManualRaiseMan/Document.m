...
{
    EmployeeView *ev = [[EmployeeView alloc] initWithEmployees:_employees];
    NSPrintInfo *printInfo = self.printInfo;
    NSPrintOperation *printOperation = [NSPrintOperation printOperationWithView:ev printInfo:printInfo];
