...
- (void)_selfAddImagesFromFolderURL:(NSURL *)folderURL
{
    ...
    for (NSURL *url in directoryEnumerator) {
        ...
        [self _presentImage:thumbImage fromURL:url];
        [self _setText:[NSString stringWithFormat:@"%0.1fs", [NSDate timeIntervalSinceReferenceDate] - t0] inLayer:_textLayer];
    }
}
